...
<#macro build content>
	<#if (content.includeContent)??>
		...
		<#if (langHelper)??>
			...
			<#if logHelper??>
				<@logHelper.debug "Included Type " + content.includeContent.type + "(category : " + includeContentFilter + "), for lang " + currentLang + " : number of subContent to display " + subContents?size/>
			</#if>
		<#else>	
			<#if logHelper??>
				<@logHelper.debug "Included Type " + content.includeContent.type + " (category : " + includeContentFilter + ") : number of subContent to display " + subContents?size/>
			</#if>
		</#if>
